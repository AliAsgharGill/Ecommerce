...
class Product(Model):
    ...
    product_image = fields.CharField(max_length=100, null=True, default='productDefault.jpg')
...
user_pydanticOut = pydantic_model_creator(User, name='UserOut', exclude=('password', 'is_verified',))

business_pydantic = pydantic_model_creator(Business, name='Business')
business_pydanticIn = pydantic_model_creator(Business, name='BusinessIn', exclude_readonly=True)


product_pydantic = pydantic_model_creator(Product, name='Product', exclude=('business',))
product_pydanticIn = pydantic_model_creator(Product, name='ProductIn', exclude_readonly=True, exclude=('percentage_discount', 'id'))
product_pydanticOut = pydantic_model_creator(Product, name='ProductOut', exclude=('business',))